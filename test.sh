...
maybe_quiet $TIMEOUT ../cmd/coordinator/main ../data/pg*txt &
pid=$!
...
(maybe_quiet $TIMEOUT ../cmd/worker/main ../plugins/wc/wc.so) &
(maybe_quiet $TIMEOUT ../cmd/worker/main ../plugins/wc/wc.so) &
(maybe_quiet $TIMEOUT ../cmd/worker/main ../plugins/wc/wc.so) &
...
(maybe_quiet $TIMEOUT ../cmd/coordinator/main ../data/pg*txt; touch $DF) &

# give the coordinator time to create the sockets.
sleep 1

# start multiple workers.
(maybe_quiet $TIMEOUT ../cmd/worker/main ../plugins/early_exit/early_exit.so; touch $DF) &
(maybe_quiet $TIMEOUT ../cmd/worker/main ../plugins/early_exit/early_exit.so; touch $DF) &
(maybe_quiet $TIMEOUT ../cmd/worker/main ../plugins/early_exit/early_exit.so; touch $DF) &
...
# start multiple workers
maybe_quiet $TIMEOUT2 ../cmd/worker/main ../plugins/crash/crash.so &
